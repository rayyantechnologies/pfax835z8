    ...
    <!-- Hero Start -->
    <section class="bg-half-130 d-table w-100" data-jarallax='{"speed": 0.5}' style="background: url('img/bg7.jpg');">
            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-12">
                    <div class="title-heading text-center">
                        ...
                        <h5 class="heading fw-semibold mb-0 sub-heading text-white title-dark">News & Events</h5>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
            </div><!--end container-->
